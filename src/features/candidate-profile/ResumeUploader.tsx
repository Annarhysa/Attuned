      ...
      <CardContent className="pt-6">
        <Tabs defaultValue="upload">
          ...
          <TabsContent value="paste" className="mt-4 space-y-3">
            <Textarea rows={12} placeholder="Paste your resume text here..." value={pasted} onChange={(e) => setPasted(e.target.value)} />
            <Button onClick={handlePasteSubmit} disabled={loading}>{loading ? 'Extracting...' : 'Extract Profile'}</Button>
          </TabsContent>
        </Tabs>
        {loading && <p className="mt-3 text-sm text-muted-foreground">Extracting your profile...</p>}
